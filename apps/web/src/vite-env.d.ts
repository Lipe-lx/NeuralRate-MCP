...
interface ImportMetaEnv {
  ...
  readonly VITE_PUBLIC_NEURALRATE_AGENT_SESSION_SIGNER_ADDRESS?: string;
  readonly VITE_PUBLIC_NEURALRATE_SAFE_4337_MODULE_ADDRESS?: string;
  readonly VITE_PUBLIC_NEURALRATE_SAFE_7579_ADAPTER_ADDRESS?: string;
  readonly VITE_PUBLIC_NEURALRATE_SAFE_7579_LAUNCHPAD_ADDRESS?: string;
  readonly VITE_PUBLIC_NEURALRATE_DELEGATE_VALIDATOR_ADDRESS?: string;
  readonly VITE_PUBLIC_NEURALRATE_4337_ENTRYPOINT_ADDRESS?: string;
