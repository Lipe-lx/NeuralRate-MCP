...
export const NEURALRATE_POLICY_REGISTRY_CONTRACT = publicPolicyRegistryContract || '';
export const NEURALRATE_EXECUTION_GUARD_CONTRACT = publicExecutionGuardContract || '';
...
export const NEURALRATE_AGENT_SESSION_SIGNER_ADDRESS = publicAgentSessionSigner || defaultAgentSmartWallet;
...
export const SAFE_4337_MODULE_ADDRESS = publicSafe4337ModuleAddress || '';
export const SAFE_7579_ADAPTER_ADDRESS = publicSafe7579AdapterAddress || '';
