...
const delegateValidatorManifest = readJson("deployments/mantle-sepolia-delegate-validator.json");
...
const safe7579LaunchpadAddress =
  safe7579LaunchpadManifest?.address || readOptionalEnv("NEURALRATE_SAFE_7579_LAUNCHPAD_ADDRESS");
const delegateValidatorAddress =
  delegateValidatorManifest?.address || readOptionalEnv("NEURALRATE_DELEGATE_VALIDATOR_ADDRESS");
const aaEntrypointAddress =
  readOptionalEnv("NEURALRATE_4337_ENTRYPOINT_ADDRESS") ||
  safe4337Manifest?.constructorArgs?.[0] ||
  safe7579LaunchpadManifest?.constructorArgs?.[0] ||
  "0x0000000071727De22E5E9d8BAf0edAc6f37da032";
const erc7484RegistryAddress =
  readOptionalEnv("NEURALRATE_ERC7484_REGISTRY_ADDRESS") ||
  safe7579LaunchpadManifest?.constructorArgs?.[1] ||
...
const sharedPublicEntries = [
  ...
  { key: "VITE_PUBLIC_NEURALRATE_SAFE_7579_LAUNCHPAD_ADDRESS", value: safe7579LaunchpadAddress, after: "VITE_PUBLIC_NEURALRATE_SAFE_7579_ADAPTER_ADDRESS" },
  { key: "VITE_PUBLIC_NEURALRATE_DELEGATE_VALIDATOR_ADDRESS", value: delegateValidatorAddress, after: "VITE_PUBLIC_NEURALRATE_SAFE_7579_LAUNCHPAD_ADDRESS" },
  { key: "VITE_PUBLIC_NEURALRATE_4337_ENTRYPOINT_ADDRESS", value: aaEntrypointAddress, after: "VITE_PUBLIC_NEURALRATE_DELEGATE_VALIDATOR_ADDRESS" },
...
updateEnvFile("apps/worker/wrangler.toml", [
  ...
  { key: "MANTLE_SEPOLIA_RPC_URL", value: readOptionalEnv("MANTLE_SEPOLIA_RPC_URL") || "", after: "NEURALRATE_AGENT_SESSION_SIGNER_ADDRESS", style: "tomlQuoted" },
...
updateEnvFile("apps/executor/wrangler.toml", [
  { key: "NEURALRATE_DATA_API_BASE_URL", value: readOptionalEnv("NEURALRATE_DATA_API_BASE_URL") || "", style: "tomlQuoted" },
  { key: "MANTLE_SEPOLIA_RPC_URL", value: readOptionalEnv("MANTLE_SEPOLIA_RPC_URL") || "", after: "NEURALRATE_DATA_API_BASE_URL", style: "tomlQuoted" },
  { key: "NEURALRATE_CHAIN_ID", value: readOptionalEnv("NEURALRATE_CHAIN_ID") || "5003", after: "MANTLE_SEPOLIA_RPC_URL", style: "tomlQuoted" },
  { key: "NEURALRATE_CHAIN_NAME", value: readOptionalEnv("NEURALRATE_CHAIN_NAME") || "Mantle Sepolia", after: "NEURALRATE_CHAIN_ID", style: "tomlQuoted" },
  { key: "NEURALRATE_ENV_PROFILE", value: readOptionalEnv("NEURALRATE_ENV_PROFILE") || "production", after: "NEURALRATE_CHAIN_NAME", style: "tomlQuoted" },
  { key: "NEURALRATE_BENCHMARK_CONTRACT", value: benchmarkAddress || "", after: "NEURALRATE_ENV_PROFILE", style: "tomlQuoted" },
  { key: "NEURALRATE_POLICY_REGISTRY_CONTRACT", value: policyRegistryAddress || "", after: "NEURALRATE_BENCHMARK_CONTRACT", style: "tomlQuoted" },
  { key: "NEURALRATE_EXECUTION_GUARD_CONTRACT", value: executionGuardAddress || "", after: "NEURALRATE_POLICY_REGISTRY_CONTRACT", style: "tomlQuoted" },
  { key: "NEURALRATE_VAULT_MODULE_ADDRESS", value: vaultModuleAddress || "", after: "NEURALRATE_EXECUTION_GUARD_CONTRACT", style: "tomlQuoted" },
  { key: "NEURALRATE_SAFE_4337_MODULE_ADDRESS", value: safe4337ModuleAddress || "", after: "NEURALRATE_VAULT_MODULE_ADDRESS", style: "tomlQuoted" },
  { key: "NEURALRATE_SAFE_7579_ADAPTER_ADDRESS", value: safe7579AdapterAddress || "", after: "NEURALRATE_SAFE_4337_MODULE_ADDRESS", style: "tomlQuoted" },
  { key: "NEURALRATE_SAFE_7579_LAUNCHPAD_ADDRESS", value: safe7579LaunchpadAddress || "", after: "NEURALRATE_SAFE_7579_ADAPTER_ADDRESS", style: "tomlQuoted" },
  { key: "NEURALRATE_DELEGATE_VALIDATOR_ADDRESS", value: delegateValidatorAddress || "", after: "NEURALRATE_SAFE_7579_LAUNCHPAD_ADDRESS", style: "tomlQuoted" },
  { key: "NEURALRATE_4337_ENTRYPOINT_ADDRESS", value: aaEntrypointAddress || "", after: "NEURALRATE_DELEGATE_VALIDATOR_ADDRESS", style: "tomlQuoted" },
  ...
  { key: "NEURALRATE_VAULT_PROVIDER_STRATEGY", value: readOptionalEnv("NEURALRATE_VAULT_PROVIDER_STRATEGY") || "safe", after: "NEURALRATE_SESSION_POLICY_VERSION", style: "tomlQuoted" },
  { key: "NEURALRATE_ONBOARDING_PROVIDER", value: readOptionalEnv("NEURALRATE_ONBOARDING_PROVIDER") || "privy", after: "NEURALRATE_VAULT_PROVIDER_STRATEGY", style: "tomlQuoted" },
  { key: "NEURALRATE_MANAGED_SIGNER_PROVIDER", value: readOptionalEnv("NEURALRATE_MANAGED_SIGNER_PROVIDER") || "turnkey", after: "NEURALRATE_ONBOARDING_PROVIDER", style: "tomlQuoted" },
  { key: "NEURALRATE_MANAGED_SIGNER_URL", value: readOptionalEnv("NEURALRATE_MANAGED_SIGNER_URL") || "", after: "NEURALRATE_MANAGED_SIGNER_PROVIDER", style: "tomlQuoted" },
  { key: "TURNKEY_API_BASE_URL", value: readOptionalEnv("TURNKEY_API_BASE_URL") || "https://api.turnkey.com", after: "NEURALRATE_MANAGED_SIGNER_URL", style: "tomlQuoted" },
]);
